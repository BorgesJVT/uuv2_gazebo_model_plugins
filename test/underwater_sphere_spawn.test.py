...
def generate_test_description():
    ...
    model_file_path = str(Path(__file__).parent / 'models/underwater_sphere.xacro')
    ...
    return (
        LaunchDescription([
            IncludeLaunchDescription(
                ...
                launch_arguments={'server_required': 'True'}.items()
            ),
            Node(
                package='gazebo_ros',
                executable='spawn_entity.py',
                arguments=['-entity', 'sphere', '-file', model_file_path],
                output='screen'
            ),
...
class TestUnderwaterSphereSpawn(unittest.TestCase):
    ...
    def test_node_names(self, proc_info):
        ...
        self.assertIn('/gazebo/default/sphere/base_link/wrench', topics)
