...
#ifndef UUV2_GAZEBO_MODEL_PLUGINS__THRUSTER_PLUGIN_HPP_
#define UUV2_GAZEBO_MODEL_PLUGINS__THRUSTER_PLUGIN_HPP_
...
#include "uuv2_gazebo_model_plugins/ThrusterConversionFunction.hpp"
#include "uuv2_gazebo_model_plugins/ThrusterDynamics.hpp"
...
typedef const boost::shared_ptr<const uuv2_gazebo_model_plugins::msgs::Double>
  ConstDoublePtr;
...
#endif  // __UUV_GAZEBO_PLUGINS_THRUSTER_PLUGIN_HPP__
