...
: BuoyantObject(_link)
{
  ...
  // Initialize filtered acceleration & last velocitys
...
/////////////////////////////////////////////////
void HydrodynamicModel::ComputeAcc(
  Eigen::Vector6d _velRel, double _time,
  double _alpha)
{
  ...
  // TODO(anyone)
  // We only have access to the acceleration of the previous simulation
...
/////////////////////////////////////////////////
void HMFossen::ComputeAddedCoriolisMatrix(
...
/////////////////////////////////////////////////
void HMFossen::ComputeDampingMatrix(
  const Eigen::Vector6d & _vel,
...
: HMFossen(_sdf, _link)
{
  ...
  // TODO(anyone) Consider also critical flow
  this->Re = 3e5;
  ...
  // TODO(anyone) Interpolate temperatures in look-up table
