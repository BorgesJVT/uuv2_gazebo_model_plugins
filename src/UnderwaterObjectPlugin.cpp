...
GZ_REGISTER_MODEL_PLUGIN(uuv2_gazebo_model_plugins::UnderwaterObjectPlugin)
...
/////////////////////////////////////////////////
void UnderwaterObjectPlugin::Load(
  ...
  sdf::ElementPtr _sdf)
{
  ...
  if (_sdf->HasElement("flow_velocity_topic")) {
    ...
    gzmsg << "Subscribing to current velocity topic: " << flowTopic <<
      std::endl;
    this->flowSubscriber = this->node->Subscribe(
      flowTopic,
...
/////////////////////////////////////////////////
void UnderwaterObjectPlugin::Update(const gazebo::common::UpdateInfo & _info)
{
...
/////////////////////////////////////////////////
void UnderwaterObjectPlugin::GenWrenchMsg(
